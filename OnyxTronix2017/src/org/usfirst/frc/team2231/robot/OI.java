...
public class OI {
    ...
    public OI() {
        ...
        joystickButton2 = new JoystickButton(buttonStick, 8);
        joystickButton2.whenPressed(new ClosePiston());
        joystickButton1 = new JoystickButton(buttonStick, 9);
        joystickButton1.whenPressed(new OpenPiston());
