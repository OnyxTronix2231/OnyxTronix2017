...
public class OI {
    ...
    public JoystickButton openingPiston;
    public JoystickButton closePiston;
    ...
    public OI() {
        ...
        closePiston = new JoystickButton(buttonStick, 8);
        closePiston.whenPressed(new ClosePiston());
        openingPiston = new JoystickButton(buttonStick, 9);
        openingPiston.whenPressed(new OpenPiston());
