...
public class RobotMap {
    ...
    public static void init() {
        ...
        shooterPIDController = new OnyxTronixPIDController(Shooter.PID_P, Shooter.PID_I, Shooter.PID_D, 0, shooterUpperWheel, shooterUpperWheel, Shooter.ABSOLUTE_TOLERANCE);
