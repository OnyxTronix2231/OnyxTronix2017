...
public class RobotMap {
    ...
    public static CANTalon climberMotor2;
    ...
    public static CANTalon triggerWheel2;
    ...
    public static void init() {
      ...
      LiveWindow.addActuator("DriveTrain", "SecondLeft", driveTrainSecondLeft);
        ...
        climberMotor2 = new CANTalon(4);
        LiveWindow.addActuator("Climber", "Motor", climberMotor2);
        ...
        shooterUpperWheel = new CANTalon(6);
        LiveWindow.addActuator("Shooter", "UpperWheel", shooterUpperWheel);
        
        shooterLowerWheel = new CANTalon(8);
        ...
        triggerWheel2 = new CANTalon(4);
        LiveWindow.addActuator("Loader", "Wheel", triggerWheel2);
