...
public class RobotMap {
    ...
    public static CANTalon climbeFirst;
    public static CANTalon climbeSecond;
    ...
    public static void init() {
        ...
        climbeFirst = new CANTalon(9);
        LiveWindow.addActuator("Climbe", "First", climbeFirst);
        
        climbeSecond = new CANTalon(8);
        LiveWindow.addActuator("Climbe", "Second", climbeSecond);
