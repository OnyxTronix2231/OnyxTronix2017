...
public class RobotMap {
    ...
    public static CANTalon shooterFirstWheel;
    public static CANTalon shooterSecondWheel;
    ...
    public static void init() {
        ...
        shooterFirstWheel = new CANTalon(7);
        LiveWindow.addActuator("Shooter", "FirstWheel", shooterFirstWheel);
        
        shooterSecondWheel = new CANTalon(4);
        LiveWindow.addActuator("Shooter", "SecondWheel", shooterSecondWheel);
