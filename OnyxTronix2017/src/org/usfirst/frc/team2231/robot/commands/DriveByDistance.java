...
public class DriveByDistance extends SetPointCommand {
    ...
    protected void execute() {
    	System.out.println("Left Output: " + RobotMap.driveTrainFirstLeft.get());
    	System.out.println("Right Output: " + RobotMap.driveTrainFirstRight.get());
    	
    	System.out.println("Left Error: " + RobotMap.driveTrainFirstLeft.getError());
    	System.out.println("Right Error: " + RobotMap.driveTrainFirstRight.getError());
    }
